...
def extract_objects(file_path, max_objects=50):
...
def convert_to_oracle_sql(doc_text):
    ...
    try:
        ...
        formatted_values = {
            ...
            'greed_premium': format_number(greed_premium),  # This will preserve decimal places
    ...
    {total_premium_paid}  -- CNP_TOTAL_PREMIUM_PAID
        ...
        sql = sql.format(**formatted_values)
        
        # Debug: Print the first 200 characters of the SQL
        print("Generated SQL (first 200 chars):", sql[:200])
        
        return sql  # Return the generated SQL statement
    except Exception as e:
...
def main():
    ...
    output_file = '/home/amawaziny/Projects/other/treviro-main/treviro/data/oracle_inserts_full.sql'
    
    print(f"Extracting up to 50 objects from {input_file}...")
    docs = extract_objects(input_file, 50)
        ...
        for i, doc in enumerate(docs, 1):
            ...
            try:
                ...
                if sql:
                    ...
                    print(f"Failed to process document {i}: convert_to_oracle_sql returned None")

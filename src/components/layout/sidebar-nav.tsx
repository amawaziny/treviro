...
import { LayoutDashboard, Briefcase, Home, Gem, DollarSign, Search, PiggyBank, TrendingDown, LineChart as CashFlowIcon, Settings } from 'lucide-react'; 
    ...
    <SidebarMenu>
      {navItems.map((item, index) => {
        ...
        if (item.exactMatch) {
          ...
          if (item.href === '/securities' && pathname.startsWith('/investments/securities')) {
            isActive = false;
          }

...
export default function FixedEstimatesPage() {
  ...
  return (
    <div className="space-y-8 relative min-h-[calc(100vh-10rem)]">
      <div>
        <h1 className="text-xl font-bold tracking-tight text-foreground">Fixed Estimates</h1>
      ...
      {fixedEstimates.length > 0 ? (
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>A list of your set recurring financial estimates.</CardDescription>
          </CardHeader>

          ...
          >
            ...
            <CardContent>
              ...
              <div className="text-xs text-red-600 dark:text-red-400 mt-1 space-y-0.5">
                ...
                {realEstateInstallmentsThisMonth > 0 && (
                  <p>
                    {`${t("real_estate_installments")} ${formatNumberForMobile(isMobile, realEstateInstallmentsThisMonth)}`}
                  </p>
                )}
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-2">
              ...
              <div className="pt-2 mt-2 border-t border-blue-100 dark:border-blue-800">
                <div className="flex justify-between items-center font-semibold">
                  ...
                  <span>
                    {formatNumberForMobile(isMobile, investmentsMadeThisMonth)}
                  </span>
                </div>
              </div>
            </CardContent>
          ...
          >
            ...
            <CardContent>
              <p className="text-xl font-medium text-gray-700 dark:text-gray-300">
                {formatNumberForMobile(
                  isMobile,
                  totalIncome - totalExpenses - investmentsMadeThisMonth,
                )}
              </p>

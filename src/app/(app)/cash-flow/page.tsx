"use client";import { useLanguage } from "@/contexts/language-context";
...
export default function CashFlowPage() {const { t: t } = useLanguage();
  const {
    incomeRecords,
    expenseRecords,
    fixedEstimates,
  ...
  const realEstateInstallments = useMemo<{
    ...
    flatMap((inv: RealEstateInvestment) => {
      return (inv.installments || []).map((installment: Installment) => ({
        ...installment,
        propertyName: inv.name || inv.propertyAddress || t("unnamed_property"),
        propertyId: inv.id
      }));
    }).
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-foreground">{t("monthly_cash_flow")}

          </h1>
          <p className="text-muted-foreground text-sm">{t("track_your_income_expenses_and_recurring_estimates_to_understand_your_monthly_cash_flow_and_financial_health")}
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6 w-full items-stretch">
        <Card className="bg-green-50 dark:bg-green-900/30 border-green-200 dark:border-green-700 flex flex-col h-[220px] flex-1">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-green-700 dark:text-green-300">{t("total_income_this_month")}
          ...
          <CardContent>
            ...
            <div className="text-xs text-green-600 dark:text-green-400 mt-1 space-y-0.5">
              ...
              <p>{t("other_logged_income_incl_sales_profit")}
                {" "}
                  <span className="md:hidden">
        ...
        <Card className="bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-700 flex flex-col h-[220px] flex-1">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-red-700 dark:text-red-300">{t("total_expenses_this_month")}
        ...
        <Card className="bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-700 flex flex-col h-[220px] flex-1">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-blue-700 dark:text-blue-300">{t("total_investments_this_month")}
          ...
          <CardContent className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-sm text-blue-700 dark:text-blue-300">{t("stocks")}
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-blue-700 dark:text-blue-300">{t("real_estate")}
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-blue-700 dark:text-blue-300">{t("debts")}
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-blue-700 dark:text-blue-300">{t("gold")}
        ...
        <Card className="bg-gray-50 dark:bg-gray-900/30 border-gray-200 dark:border-gray-700 flex flex-col h-[220px] flex-1">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-700 dark:text-gray-300">{t("remaining_cash_after_expenses_investments")}
          ...
          <CardContent>
            ...
            <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">{t("remaining_total_income_total_expenses_total_investments")}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full mt-6">
        ...
        <Card className="flex flex-col h-full min-h-[220px]">
          <CardHeader>
            ...
            <CardDescription>{t("breakdown_of_income_for")}
          ...
          <CardContent className="space-y-2">
            ...
            <div
              ...
              className="flex justify-between text-xs">
                    ...
                    <span>
                      {formatDateDisplay(tx.date)}{t("dividend")}{" "}
            ...
            <div className="flex justify-between text-xs">
                <span>
                  <FileText className="inline mr-2 h-4 w-4 text-green-600" />{t("projected_debt_interest")}
        ...
        <Card className="flex flex-col h-full min-h-[220px]">
          <CardHeader>
            ...
            <CardDescription>{t("breakdown_of_expenses_for")}
              {formatMonthYear(currentMonthStart)}.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
            ...
            <div className="flex justify-between items-center text-red-500 font-semibold">
                <span className="flex items-center gap-1">
                  <Gift className="h-4 w-4" />{t("zakat_fixed")}
            ...
            <div className="flex justify-between items-center text-red-500 font-semibold">
                <span className="flex items-center gap-1">
                  <HandHeart className="h-4 w-4" />{t("charity_fixed")}
            ...
            <div className="flex justify-between items-center text-red-500 font-semibold">
                <span className="flex items-center gap-1">
                  <TrendingDown className="h-4 w-4" />{t("living_expenses")}
            ...
            {otherFixedExpensesMonthly > 0 &&
            <div className="flex justify-between items-center text-red-500 font-semibold">
                <span className="flex items-center gap-1">{t("other_fixed_expenses")}
            ...
            {totalItemizedExpensesThisMonth > 0 &&
            <div className="flex justify-between items-center text-red-500 font-semibold">{t("itemized_logged_expenses")}
              {" "}
                <span>
                  {formatNumberWithSuffix(totalItemizedExpensesThisMonth)}
                </span>
        ...
        <Card className="flex flex-col h-full min-h-[220px]">
          <CardHeader>
            ...
            <CardDescription>{t("new_investments_made_in")}
              {formatMonthYear(currentMonthStart)}.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
            <div>
              ...
              <div className="flex justify-between items-center text-blue-600 font-semibold mb-2">
                <span className="flex items-center gap-2">{t("total_stock")}</span>
                <span>
                  {formatNumberWithSuffix(totalStockInvestmentThisMonth)}
                </span>
              </div>
              ...
              <div className="mb-2">
                    <div className="font-semibold text-blue-800 dark:text-blue-200 flex items-center gap-2">
                      <Wallet className="h-4 w-4" />{t("debt_instruments_purchased")}
              ...
              <div className="mb-2">
                    <div className="font-semibold text-blue-800 dark:text-blue-200 flex items-center gap-2">
                      <Coins className="h-4 w-4" />{t("gold_purchased")}

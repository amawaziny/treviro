...
export default function IncomePage() {
  ...
  return (
    <div className="space-y-8 relative min-h-[calc(100vh-10rem)]">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-foreground">Income Records</h1>
        <p className="text-muted-foreground">Track your salary, profit shares, and other cash inflows.</p>
      </div>
      <Separator />
